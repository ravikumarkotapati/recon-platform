...
SET AUTHREC PROFILE('RECON.BACKOUT') OBJTYPE(QUEUE) PRINCIPAL('$Principal') AUTHADD(PUT,GET,BROWSE,INQ,DSP,PASSALL)
SET AUTHREC PROFILE('RECON.REPLAY') OBJTYPE(QUEUE) PRINCIPAL('$Principal') AUTHADD(PUT,GET,BROWSE,INQ,DSP)
SET AUTHREC PROFILE('SYSTEM.DEAD.LETTER.QUEUE') OBJTYPE(QUEUE) PRINCIPAL('$Principal') AUTHADD(PUT,GET,BROWSE,INQ,DSP,PASSALL)
